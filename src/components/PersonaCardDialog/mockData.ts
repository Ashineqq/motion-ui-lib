...
export const PERSONAS: PersonaData[] = [
  {
    ...
    title: "B 站学习者",
    tagline: "边看边掌握",
    scenario: "你关注的 UP 主更新了一个小时的 Python 教程，讲了装饰器、闭包、生成器。看到第三章回头，已经记不清前面讲了什么。",
    features: [
      { label: "时间戳跳转", desc: "点「闭包」直接跳到视频 8:25" },
      { label: "40 分钟变 8 章节", desc: "视频自动拆分章节，每个知识点标时间戳" },
  ...
  },
  {
    ...
    scenario: "你刚看了一个 40 分钟的行业分析视频，想写小红书笔记。信息量大，手动整理至少半小时。",
    features: [
